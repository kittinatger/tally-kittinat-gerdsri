    ...
    <div className="mt-6 space-y-4 border-t border-line pt-4">
      <div className="rounded-card border border-line bg-surface p-4">
        ...
        <p className="text-xs leading-relaxed text-ink-soft">
          ...
          <code className="rounded bg-bg-soft px-1 py-0.5">{"{origin}"}/api/intake/receipt</code>, Method{" "}
          <strong>POST</strong>, Headers <code className="rounded bg-bg-soft px-1 py-0.5">Authorization: Bearer &lt;your token&gt;</code>,
          Request Body <strong>Form</strong> with a field named <code className="rounded bg-bg-soft px-1 py-0.5">image</code> set to
          Shortcut Input (the photo). Turn off &quot;Ask Before Running&quot; so it fires silently.
        </p>
      </div>
