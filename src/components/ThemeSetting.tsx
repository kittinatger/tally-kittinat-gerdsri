...
export default function ThemeSetting() {
  // Safe to read the DOM directly here (no effect needed): ThemeSync (mounted
  // in the root layout) has already applied data-theme before this renders.
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-card border border-line bg-surface p-5">
      ...
      >
        {theme === "dark" ? (
          <svg viewBox="0 0 25.4297 25.3088" fill="currentColor" className="h-[19px] w-[19px]">
          ...
          <svg viewBox="0 0 27.4805 27.1973" fill="currentColor" className="h-[19px] w-[19px]">
