...
// The default Settings-page layout (id "groupedCards") — today's original
// look, unchanged: bordered profile card with the theme toggle,
// collapsible sections each in one bordered/divided card, circular icon
// badges + chevrons. See src/lib/settings-nav-data.tsx for the section/
// row data every layout (including this one) reads from.
