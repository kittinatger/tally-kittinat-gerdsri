...
export const config = {
  matcher: [
    "/((?!login|register|forgot-password|reset-password|api/auth/login|api/auth/register|api/auth/forgot-password|api/auth/reset-password|_next/static|_next/image|favicon.ico|favicon-light.svg|favicon-dark.svg).*)",
  ],
};
