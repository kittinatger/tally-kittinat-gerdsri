// Exactly the symbologies both the client-side renderer (bwip-js) and the
// camera scanner (@zxing/browser) support well.
export const MEMBERSHIP_CODE_FORMATS = ["qr", "code128", "ean13", "upc", "pdf417", "aztec"] as const;
